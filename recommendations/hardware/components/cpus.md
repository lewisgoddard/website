...
|-----|-------|---------|-----|-------------|------------|-------|--------|
| 12100   | 4+0 | 8 | {{ cpu.tdp }} | {{ cpu.thread }} | {{ cpu.score }} | {{ cpu.price }} | {% include cpu-row.html cpu="12100" %}
| 12100F  | 4+0 | 8 | {{ cpu.tdp }} | {{ cpu.thread }} | {{ cpu.score }} | {{ cpu.price }} | {% include cpu-row.html cpu="12100F" %}
