...
|-----|-------|---------|-----|-------------|------------|-------|--------|
| 12100   | 4+0 | 8 | {% assign cpu = site.data.cpus['13100'] %}{{ cpu.tdp }} | {{ cpu.thread }} | {{ cpu.score }} | {{ cpu.price }} | {% include cpu-row.html cpu=cpu %}
| 12100F  | 4+0 | 8 | {% assign cpu = site.data.cpus['12100F'] %}{{ cpu.tdp }} | {{ cpu.thread }} | {{ cpu.score }} | {{ cpu.price }} | {% include cpu-row.html cpu=cpu %}
